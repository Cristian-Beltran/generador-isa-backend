...
export class Migration1762103969845 implements MigrationInterface {
    name = 'Migration1762103969845'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "devices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "serialNumber" character varying NOT NULL, "model" character varying NOT NULL, "status" "public"."devices_status_enum" NOT NULL DEFAULT 'ACTIVE', "patientId" uuid, CONSTRAINT "REL_37c3356b21e66a124392ed1097" UNIQUE ("patientId"), CONSTRAINT "PK_b1514758245c12daf43486dd1f0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "session_data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "measuredCurrent_mA" double precision NOT NULL, "temperature_C" double precision NOT NULL, "recordedAt" TIMESTAMP NOT NULL DEFAULT now(), "sessionId" uuid NOT NULL, CONSTRAINT "PK_791c7014ec3aa653c58410c14e8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_session_data_recorded_at" ON "session_data" ("recordedAt") `);
        await queryRunner.query(`CREATE TABLE "sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "startedAt" TIMESTAMP NOT NULL DEFAULT now(), "endedAt" TIMESTAMP, "durationSeconds" integer NOT NULL, "targetCurrent_mA" double precision NOT NULL, "patientId" uuid NOT NULL, "deviceId" uuid NOT NULL, CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
